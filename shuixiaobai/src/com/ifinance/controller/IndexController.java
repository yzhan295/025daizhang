...
public class IndexController extends BaseController {
	...
	public void index() {
		Map<String, List<News>> topNews = service.getTopNews(this);
		
		setAttr("topZixun", topNews.get("topZixun"));
		setAttr("topShuiwu", topNews.get("topShuiwu"));
		setAttr("topFaq", topNews.get("topFaq"));
